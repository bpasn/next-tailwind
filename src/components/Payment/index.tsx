...
const CartPayment = (props: Props) => {
    const { productData, userInfo } = useSelector((state: StateProps) => state.next) as IInitialState
        ...
        <div className='flex flex-col gap-4'>
            ...
            {userInfo ? (
                <div className='flex flex-col items-center'>
                    <button className='w-full h-10 text-sm font-semebold bg-amazon_blue bg-opacity-50 text-white rounded-lg
