...
const BottomHeader = (props: Props) => {
    ...
    return (
        <div className='w-full h-10 bg-amazon_light text-sm text-white px-4 flex items-center'>
            ...
            <button onClick={handleSignout} className='hidden md:inline-flex items-center h-8 px-2 border border-transparent hover:border-red-600 hover:text-red-600 text-amazon_yellow cursor-pointer duration-300 '>
                Sign out
            </button>
                    ...
                    <div className="w-full h-full relative">
                        <motion.div
                            ...
                            <div className='w-full bg-amazon_light text-white py-2 px-6 flex items-center gap-4'>
                                <MdAccountCircle />
                                <h3 className="font-titleFont font-blod">
                                    Hello Signin
                                </h3>
                            </div>
